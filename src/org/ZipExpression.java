...
public class ZipExpression extends Base implements Parameter {
	...
	public static void main(String[] args) {
		...
		try {
			ZipExpression expressionTrans = new ZipExpression();
			if (args.length > 0) {
...
//					org.tools.DelXmlFolder.delAllFile("D:\\workspace\\Uoo\\xml\\");
	...
	protected void createMappings() throws Exception {
		...
		// TODO Auto-generated method stub
		mapping = new Mapping(
				"M_" + Platfrom + "_" + org.tools.GetProperties.getKeyValue("TableNm").toUpperCase() + "_I", "mapping",
				"");
